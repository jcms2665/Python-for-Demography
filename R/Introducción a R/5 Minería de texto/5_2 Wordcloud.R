...
setwd("D:/OneDrive - El Colegio de México A.C/5. Proyectos/2021/46. SIGMA/3 R-intro/5 Minería de texto/Datos")
...
#4. Limpiar texto
    ...
    docs <- tm_map(docs, reemplazar, "@")
    docs <- tm_map(docs, reemplazar, ";")
    rdocs <- tm_map(docs, reemplazar, "Â¿")
    docs <- tm_map(docs, reemplazar, ":")
...
barplot(d[1:10,]$freq, las = 2, names.arg = d[1:10,]$word,
        col ="lightblue", main ="Palabras mÃ¡s frecuentes",
        ylab = "Frecuencias")
